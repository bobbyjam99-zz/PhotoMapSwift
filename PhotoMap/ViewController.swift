...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.prepareMapView()
        self.checkAuthorizationsStatus()
    ...
    private func prepareMapView() {
        ...
        let centerCoorinate = CLLocationCoordinate2D(latitude: 35.681382, longitude: 139.766084)
        let initialSpan = MKCoordinateSpan(latitudeDelta: 0.4, longitudeDelta: 0.4)
        let initialRegion = MKCoordinateRegion(center: centerCoorinate, span: initialSpan)
        self.mapView.setRegion(initialRegion, animated: true)
    }

    private func checkAuthorizationsStatus() {
